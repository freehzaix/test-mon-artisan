        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Les assurances</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="col-4">
                    <div class="card card-primary">
                        <div class="card-header">
                          <h3 class="card-title">Ajouter une assurance</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        @if(session('status'))
                        ...
                        @endif
                        <form action="{{ route('assurance') }}" method="POST">
                            @csrf
                          <div class="card-body">
                            <div class="form-group">
                              <label for="assurance">Nom de l'assurance</label>
                              <input type="text" class="form-control" id="assurance" name="assurance" placeholder="Ajoutez une assurance..">
                            </div>
                          </div>
                          <!-- /.card-body -->
